...
Accepted exact published platform and hosted NES refresh after primary review. This extends the reviewed NES guest to the named nova-ae-linux-x86_64-kvm-oracle-v1 configuration; it does not admit arbitrary oracle configurations.
...
The guest composition review digest is 0e4c4ed4022cd9030464adf0f4a15b7af31a13ef4998f0a67c97825afcf55775. It excludes only host source/executable hashes; these remain bound in each full candidate and verification checks the actual executable. Host source changes still require normal PR review and runtime qualification; a matching guest composition is not approval of arbitrary host behavior.
