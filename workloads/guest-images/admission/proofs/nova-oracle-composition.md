...
Accepted by the Codex primary agent on 2026-09-14 after source and exact-artifact review. This extends the reviewed NES guest to the named nova-ae-linux-x86_64-kvm-oracle-v1 configuration; it does not admit arbitrary oracle configurations.
