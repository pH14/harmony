...
shows which part of the drawn range a workload's executions reach. On the
SQLite WAL reset and etcd cases no park with a threshold of `1 << 14` or more
fired, which sets the top of the drawn range.
