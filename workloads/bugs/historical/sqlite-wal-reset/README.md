...
- Harness: the `antithesis/` directory of
  ...
  `3ce53bc469dcef8d8c2d90eb59a7d13184e782e5` (SQLite 3.51.2). The fixed build
  is the same fork at `ac1a538a559d94801b29a96f96fd8f9e0943f88f` (SQLite 3.51.3),
  whose `antithesis/workload.c` is byte-identical.
- Fix: the [3.51.3 release notes](https://sqlite.org/releaselog/3_51_3.html).
...
Pass `--build-arg SQLITE_COMMIT=ac1a538a559d94801b29a96f96fd8f9e0943f88f` for
the 3.51.3 control.
