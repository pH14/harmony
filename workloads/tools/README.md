...
the comparison-16 edge, import portable snapshots into independent
...
comparison-16 edge. A reaches the boundary without an additional
...
uses the default sequence; every success report records the seed.

### Candidate admission for the Linux x86 Nova A–E oracle

Prepare the actual oracle composition without booting a VM:
