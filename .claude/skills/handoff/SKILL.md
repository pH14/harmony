...
GPT-5.6 Sol — the sole cross-model pass since `c21711d` dropped pi), the iterate-until-clean cycle,
...
GPT-5.6 Sol — the sole cross-model pass; see `.claude/skills/pr-review/SKILL.md`), iterates the
