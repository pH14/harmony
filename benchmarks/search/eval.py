...
ALLOWED_SEARCH = {'seed','workers','executions','frames','memory_mib','window','result_slots','wall_seconds','suffix','mixture','verification'}
...
def expand_suite(suite, selected=None):
    ...
    for case in suite['cases']:
        ...
        for seed,workers,memory in itertools.product(suite['seeds'],suite['workers'],suite['memory_mib']):
            ...
            for field in ('seed','workers','memory_mib','executions','window','wall_seconds'):
                val=request[field]
