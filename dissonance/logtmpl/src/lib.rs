...
//! never learn that clustering exists. The [`Codebook`] is a deterministic,
//! all-integer fold whose byte-identical serialization survives
//! serialize → reload → continue (gates 2–3).
//!
