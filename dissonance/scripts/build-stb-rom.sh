...
. "$repo_root/dissonance/stb-versions.env"
...
output_dir=${1:-"$repo_root/dissonance/stb-build"}
mkdir -p "$output_dir"
...
install -m 0644 "$repo_root/dissonance/stb-versions.env" "$output_dir/stb-versions.env"
