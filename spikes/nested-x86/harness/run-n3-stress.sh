...
# PROMOTED VERBATIM (PR #98 round-3 #3) from harness/box-retrieved/run-n3-stress.sh —
# this is the authoritative as-run script the N-3 recert drivers invoke at
# /root/nested-x86-spike/run-n3-stress.sh (see the staging map in ../README.md);
# box-retrieved/ keeps the provenance copy.
set -euo pipefail
