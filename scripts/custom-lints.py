...
RULES: list[Rule] = [
    ...
    Rule(
        ...
        remediation=(
            "The fault runtime, supervisor, fault policy, faults package, guest "
            "driver, and SDK decoding must find bugs without knowing them. Remove "
    ...
    Rule(
        ...
        description="The searcher must not name the storage engine or its write-ahead log.",
        remediation=(
            "The searcher is workload-agnostic. Remove the reference to SQLite, "
            "its WAL, or backfill. Campaign checkpoints keep their name."
        ),
