...
# consonance/vmm-core/contracts/x86/guest.toml (and EXECUTION_TICK_VNS in vendor/arm64/contract.rs).
...
CONTRACT_TOML = Path(__file__).resolve().parent.parent / "consonance" / "vmm-core" / "contracts" / "x86" / "guest.toml"
