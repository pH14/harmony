...
test('reports failed matrix cases and links evidence without trusting names as HTML', async () => {
  ...
  const jobs = [{name:'Nova <failed>',html_url:'https://example.test/job',conclusion:'failure',started_at:'2026-01-01T00:00:00Z',completed_at:'2026-01-01T00:00:12Z'}, {name:'Report / NES campaign report'}];
