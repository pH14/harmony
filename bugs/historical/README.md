...
|---|---|---|---|---|---|---|---|
| [postgres-cic-corruption](postgres-cic-corruption/README.md) | 14.3 / 14.4 | specified | guided | — | — | — | `harmony search --package faults IMAGE-14.3.oci --kernel bzImage-faultlab --fault-agent fault-agent --replay bugs/historical/postgres-cic-corruption/probe.json --repeat 2 --horizon-ms 500 --ram-mib 1024 --out OUT` |
