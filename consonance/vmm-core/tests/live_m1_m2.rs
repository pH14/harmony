...
//! payloads, and a Linux x86-64 KVM host — none of
...
//! ```
//!
//! Missing KVM access or payload artifacts is a test failure. No physical CPU
//! model or microcode revision is required.
//!
...
#[test]
#[ignore = "box-only live gate (real KVM + built payloads + x86-kvm host); run on \
