...
///
/// **Moved deliberately at v3:** the retired branch-ratio pair was removed from
/// the virtual-time section. The version bump prevents an older decoder from
/// interpreting the shorter record.
