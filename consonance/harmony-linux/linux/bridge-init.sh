...
#
# The kernel must carry CONFIG_HARMONY_DEVICE=y (consonance/harmony-linux/linux/config-fragment,
# added by PR #133 on 2026-07-20 — every bzImage built before that date has no
# /dev/harmony at all, so `make -C consonance/harmony-linux/linux kernel` is a precondition of
