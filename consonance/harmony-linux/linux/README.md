...
full-state checkpoints through completion. The N6 instruction sweep separately
checks counter instruction behavior and its traps-off negative control. These
are focused runtime and counter regressions; they do not establish deterministic
preemption for arbitrary computation or qualify etcd's complete workload.
