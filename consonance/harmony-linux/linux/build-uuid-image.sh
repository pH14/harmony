...
# Build the **bug-3 (rare-entropy-value) benchmark initramfs**: the
# bare-Postgres image (a static busybox + a real PostgreSQL 17 install +
...
# consonance/harmony-linux/build/initramfs-uuid.cpio.gz.
#
