# `hypercall-doorbell` — implementation notes
...
MIRIFLAGS=-Zmiri-permissive-provenance \
  cargo +nightly-2026-06-16 miri test -p hypercall-doorbell
...
- `hypercall-proto` is depended on **unmodified**; the only files changed outside
  `consonance/hypercall-doorbell/` are the three sanctioned doc surfaces (INTEGRATION.md,
