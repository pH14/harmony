...
backstop, a native pinned-N1 build, or an AA-5 runtime result; those remain box
work. The shared `atomic_ll_sc.h` include remains because upstream's LSE header
