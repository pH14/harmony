...
# bare-Postgres init (harmony-linux/linux/pg-init.sh) plus the planted-bug supervisor
...
# harmony-linux/linux/campaign-super.c and harmony-linux/linux/IMPLEMENTATION.md.
#
