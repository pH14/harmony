...
# It is the task-37 bare-Postgres init (harmony-linux/linux/pg-init.sh) plus the
...
# supervisor/markers swapped. See harmony-linux/linux/order-super.c and
# harmony-linux/linux/IMPLEMENTATION.md.
#
