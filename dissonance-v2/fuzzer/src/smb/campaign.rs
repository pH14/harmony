...
pub fn selector_identifier(policy: SmbArchiveSelectorPolicy) -> String {
    match policy {
        ...
        SmbArchiveSelectorPolicy::RoomCellUniform => "room_cell_uniform_128".to_owned(),
...
pub fn selector_from_identifier(
    ...
    if identifier == "room_cell_uniform_128" {
        return Ok(SmbArchiveSelectorPolicy::RoomCellUniform);
    }
