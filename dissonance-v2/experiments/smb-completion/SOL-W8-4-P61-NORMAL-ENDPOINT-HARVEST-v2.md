...
# Sol World 8-4 p61 normal endpoint harvest v2

Status: preregistered after p61 result commit and before implementation,
...
probe-surviving p61 endpoint. Repeat the identical generic B1 mechanism with a
fresh seed: 12 lanes x512 one-action draws. No route, button, duration,
...
- Code/result commit `6bd11649fc9edb3e99914621c18269416375d3ef`.
- Authorizing prereg `4f0e7549`, implementation `597ea67f`, result `6bd11649`,
  report SHA `255f9b430841303a4e5d9c9d6eb9820c1887ba9c7b3c3f5192d53c2c1eb87e59`.
- Source
...
- Final chord `{buttons:0,hold_frames:11}`; mask00 survives exact 45-frame
  source probe. ROM SHA
  `0b3d9e1f01ed1668205bab34d6c82b0e281456e137352e4f36a9b2cfa3b66dea`.
- Seed label `sol-restart-w8-4-p61-normal-endpoint-harvest-v2`; SHA
  `971462f832773e4c808b9b2918ea905e622e56bbbba08c92bef8b60ab55e4ec6`;
  first8 little-endian master `5493959656237831319`.

Binary `smb-w8-4-p61-normal-endpoint-harvest-v2` takes input/output paths and
...
```text
lane_seed = first8_le(SHA256(master_le || "w8-4-p61-v2-lane" || l_le))
index = first8_le(SHA256(lane_seed_le || "w8-4-p61-v2-action" || d_le)) mod 3549
selector_seed = first8_le(SHA256(lane_seed_le || "w8-4-p61-v2-parent" || d_le))
```
...
replay167,136; source probe45; setup4,693; **1,738,594 total**. Checked
